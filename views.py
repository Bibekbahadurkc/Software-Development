...
def cart(request):
    ...
    return render(request,'toys/cart.html',context)
...
FROM toys_order dzz
left join toys_orderitem dop on  dop.order_id=dzz.id
left join toys_shippingaddress dxx on dxx.order_id=dzz.id
...
where dzz.customer_id = %s""",(userid,))
    ...
    return render(request, 'toys/history.html', context)
...
def post_event(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            return redirect('/toys/get_event/')
        else:
            messages.add_message(request, messages.ERROR, 'Sorry! Something went wrong')
            return render(request, 'toys/post_event.html', {'form_file': form})

    context={
        'form_file':form,
        'activate_event': 'active',
    }
    return render(request,'toys/post_event.html',context)
...
def get_event(request):
    ...
    return render(request, 'toys/get_event.html', context)
...
def update_event(request,file_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.ERROR, 'Sorry! Something went wrong')
            return render(request, 'toys/update_event.html', {'form_file': form})
    ...
    return render(request,'toys/update_event.html',context)
@user_only
def show_event(request):
    ...
    return render(request,'toys/event.html',context)
...
def event_detail(request,file_id):
    ...
    return render(request,'toys/event_detail.html',context)
